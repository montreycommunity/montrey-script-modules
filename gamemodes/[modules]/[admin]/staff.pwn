...
static stock const USER_PATH[64] = "/Korisnici/%s.ini"; 			//!Putanja korisnika

new stfveh[MAX_PLAYERS] = { INVALID_VEHICLE_ID, ... }; 				//!Provera za admin vozilo

static
	iStaff[MAX_PLAYERS],											//!Provera dal je igrac staff
	iSkin[MAX_PLAYERS],												//!Skin igraca
	iStaffDutyTime[MAX_PLAYERS];                         		    //!Staff vreme na duty

new bool:StaffDuty[MAX_PLAYERS];									//!Provera za staff duty (0,1)

//!Hookuje ucitavanje korisnika i dodaje 2 nove stvari u load
...
//!Cuvanje kada se igrac disconnectuje
...
//!Teleport za staff kada klikne lokaciju na mapi
...
//!Unistavanje vozila kad eksplodira
